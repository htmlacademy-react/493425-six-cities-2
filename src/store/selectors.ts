...
export const selectCityOffers = createSelector([selectOffers, selectSorting, selectCity], (offers, sorting, city) => {
  return sortOffers(sorting, getCityOffers(city, offers));
});
